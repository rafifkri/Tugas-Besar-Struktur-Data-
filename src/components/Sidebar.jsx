  ...
  return (
    <div className='bg-neutral-900 h-full w-1/4 rounded-lg px-4 pt-4 flex flex-col font-playG'>
      ...
      <div className='flex flex-col space-y-2'>
        ...
        {/* <Link to="/library" className='flex items-center text-gray-300 hover:text-white hover:bg-neutral-800 p-2 rounded-md transition'>
          <img src="/img/library.png" className='w-6 h-6 mr-3' alt="Library" />
